    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" @closed="afterClose" width="30%" >
      <el-form label-width="120px" :model="editForm" :rules="title=='添加'&&flush?editRules:{}" ref="editForm">
        <el-form-item label="矿泉水编号" prop="sno" v-if="this.title=='添加'?false:true">
          <el-input size="small" :disabled="title=='编辑'?true:false" v-model="editForm.wno" auto-complete="off" placeholder="请输入客户编号"></el-input>
        </el-form-item>
        ...
        <el-form-item label="矿泉水名称" prop="wname">
          <el-input size="small"  v-model="editForm.wname" auto-complete="off" placeholder="请输入供货商名称"></el-input>
        </el-form-item>
        <el-form-item label="矿泉水品牌" prop="wbrand" >
          <el-input size="small"  v-model="editForm.wbrand" auto-complete="off" placeholder="请输入供货商地址"></el-input>
        </el-form-item>
        <el-form-item label="单价" prop="price">
          <el-input size="small" v-model="editForm.price" auto-complete="off" placeholder="请输入客户地址"></el-input>
        </el-form-item>  
        <el-form-item label="库存" prop="store">
          <el-input size="small" v-model="editForm.store" auto-complete="off" placeholder="请输入客户地址"></el-input>
        </el-form-item>  
        <el-form-item label="销量" prop="sale">
          <el-input size="small" v-model="editForm.sale" auto-complete="off" placeholder="请输入客户地址"></el-input>
        </el-form-item>                 
      </el-form>
      <div slot="footer" class="dialog-footer">
